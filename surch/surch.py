...
github_user = click.option('-U', '--user', default=None,
                           help='GitHub username')
github_password = click.option('-P', '--password', default=None,
                               help='GitHub password')

owner = click.option('-o', '--owner', default=None,
                     help='GitHub organization\user')
repo_name = click.option('-r', '--repo', default=None,
                         help='GitHub commit repo name')
